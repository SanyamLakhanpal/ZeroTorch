# https://github.com/hkproj/pytorch-transformer-distributed/blob/main/train.py
...
"""
- Apart from standard forward pass you have to do modele.module.encode or .decode()
"""
...
def train_model(config: ModelConfig):
    ...
    for epoch in range(initial_epoch, config.num_epochs):
        ...
        for batch in batch_iterator:
            ...
            decoder_output = model.module.decode(encoder_output, encoder_mask, decoder_input,
